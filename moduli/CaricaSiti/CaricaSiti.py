...
class CaricaSiti:
    ...
    def __init__(self, NirGis):
        ...
        self.nomeDelModulo = u"Carica Siti"
        self.versione = "4.0"
        self.sperimentale = False       
        self.lstMenu = [
        [u'Carica Impianti',self.runSiti,""],
        [u'Ridefinisci Impianti',self.ridefinisciDaMenuSiti,""],
        [u'Carica Sorgenti',self.scarica_antenne_diagrammi,""],
        [u'Info. Sorgenti calcolo',self.showInfSez,""],
        [u'Finestra Impianti',self.richiamaDaMenuFinestraImpianti,"F12"],
        [u"Aggiorna DB",self.modificaDB,""]]

    
    def runSiti(self):
        print (u'carica siti')
    def ridefinisciDaMenuSiti(self):
        print (u'ridefinisci siti')
    def scarica_antenne_diagrammi(self):
        print (u'carica sorgenti')
    def showInfSez(self):
        print (u'Info. Sorgenti calcolo')
    def richiamaDaMenuFinestraImpianti(self):
        print (u'Finestra Siti')
    def modificaDB(self):
        print (u"Aggiorna DB")
